...
await initUsers().then(() => initProducts());
...
async function initUsers() {
  ...
  const insertResult = await User.insertMany([
    { 
      username: 'admin', 
      email: 'admin@nodepop.com', password: await User.hashPassword('admin'), profileImage: './public/images/userpic', roles: ['admin'] 
    },
    { 
      username: 'hector', 
      email: 'hector@gmail.com', password: await User.hashPassword('hector'), profileImage: './public/images/userpic', roles: ['user'] 
    }
  ])
